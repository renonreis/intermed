<?php
/**
 * intermed functions and definitions
 *
...
if ( ! function_exists( 'intermed_setup' ) ) :
	/**
	 ...
	 */
	function intermed_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on intermed, use a find and replace
		 * to change 'intermed' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'intermed', get_template_directory() . '/languages' );
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'intermed_custom_background_args',
				array(
...
add_action( 'after_setup_theme', 'intermed_setup' );
 ...
 */
function intermed_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'intermed_content_width', 640 );
}
add_action( 'after_setup_theme', 'intermed_content_width', 0 );
 ...
 */
function intermed_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'intermed' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'intermed' ),
...
add_action( 'widgets_init', 'intermed_widgets_init' );
